                                             ...
                                             <div class="product">
                                                ...
                                                <div class="product_img">
                                                    ...
                                                    <div class="product_action_box">
                                                        <ul class="list_none pr_action_btn">
                                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> View Cart Options</a></li>
                                                ...
                                                <div class="product_info">
                                                    <h6 class="product_title">
                                                      <inertia-link :href="route('single-product', product.product_slug)" >{{product.product_name}}</inertia-link>
                                                    </h6>
                                                    <div class="product_price" v-if="product.product_combinations.length > 0">   
                                                        <span class="price">${{ minPrice(product)}}.00 - ${{ maxPrice(product)}}.00 </span>
                                                    </div>
                                                    <div class="product_price" v-else>   
                                                        <span class="price">Product Not Available</span>
                                                    </div>
                                                    <div class="pr_desc">
